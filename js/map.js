...
const MapData = {
    initialNodes: [
        ...
        { id: 'KAN', abbr: 'KAN', name: '堪萨斯城', factionId: 'AUS', x: 548, y: 362, row: 3, col: 4, industry: 1, troops: 3, terrain: '平原城市', tags: [] },
        { id: 'OKC', abbr: 'OKC', name: '俄克拉荷马城', factionId: 'AUS', x: 526, y: 452, row: 4, col: 4, industry: 1, troops: 3, terrain: '平原油田', tags: ['油田'] },
        { id: 'STL', abbr: 'STL', name: '圣路易斯', factionId: 'AUS', x: 640, y: 342, row: 3, col: 5, industry: 2, troops: 4, terrain: '河港城市', tags: [] },
        ...
        { id: 'WAS', abbr: 'WAS', name: '华盛顿', factionId: 'USA', x: 860, y: 326, row: 2, col: 9, industry: 3, troops: 7, terrain: '军政府首都', tags: ['首都'], isCapital: true },
        { id: 'BAL', abbr: 'BAL', name: '巴尔的摩', factionId: 'USA', x: 842, y: 292, row: 2, col: 8, industry: 2, troops: 4, terrain: '港口城市', tags: ['港口'] },
        { id: 'PHI', abbr: 'PHI', name: '费城', factionId: 'USA', x: 872, y: 258, row: 1, col: 9, industry: 3, troops: 4, terrain: '工业城市', tags: [] },
        { id: 'NYC', abbr: 'NYC', name: '纽约', factionId: 'USA', x: 902, y: 220, row: 0, col: 9, industry: 4, troops: 5, terrain: '港口都会', tags: ['港口'] },
        { id: 'RIC', abbr: 'RIC', name: '里士满', factionId: 'USA', x: 840, y: 372, row: 3, col: 9, industry: 2, troops: 4, terrain: '前线城市', tags: [] },
        ...
        { id: 'BHM', abbr: 'BHM', name: '伯明翰', factionId: 'CON', x: 704, y: 486, row: 4, col: 6, industry: 2, troops: 4, terrain: '钢铁工业区', tags: [] },
        { id: 'CHA', abbr: 'CHA', name: '夏洛特', factionId: 'CON', x: 820, y: 424, row: 3, col: 8, industry: 2, troops: 4, terrain: '卡罗莱纳工业城', tags: [] },
