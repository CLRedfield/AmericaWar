...
const MapData = {
    initialNodes: [
        ...
        { id: 'ALB', abbr: 'ALB', name: '奥尔巴尼', factionId: 'NEN', x: 890, y: 176, row: 0, col: 8, industry: 1, troops: 3, terrain: '山麓城市', tags: [] },
    ...
    connections: [
        ...
        ['STL', 'CHI'], ['STL', 'PIT'], ['STL', 'LRK'], ['STL', 'BHM'], ['LRK', 'BAT'], ['LRK', 'BHM'], ['BAT', 'NOL'], ['BAT', 'HOU'], ['NOL', 'HOU'], ['NOL', 'SAV'],
